...
`define CV32E40P_CORE   $root.uvmt_cv32e40p_tb.dut_wrap.cv32e40p_top_i.core_i
`define CV32E40P_TRACER $root.uvmt_cv32e40p_tb.dut_wrap.cv32e40p_top_i.tracer_i
   ...
   function automatic void compare();
      ...
      foreach(`CV32E40P_RM_RVVI_STATE.csr[index]) begin
          ...
          case (index)
            ...
            "marchid"       : csr_val = cv32e40p_pkg::CSR_MARCHID_VALUE; // warning!  defined in cv32e40p_pkg

            "mcountinhibit" : csr_val = `CV32E40P_CORE.cs_registers_i.mcountinhibit_q;

            "mvendorid"     : csr_val = cv32e40p_pkg::CSR_MVENDORID_VALUE; // warning!  defined in cv32e40p_pkg
//            "mvendorid"     : csr_val = {cv32e40p_pkg::MVENDORID_BANK, cv32e40p_pkg::MVENDORID_OFFSET};
          ...
          //                    else csr_val = `CV32E40P_CORE.cs_registers_i.mip;
            ...
            "instreth"      : ignore  = 1;
//            "minstret"      : ignore  = 1;
            "minstret"      : `CV32E40P_CORE.cs_registers_i.minstret_raw[31:0];
//            "minstreth"     : ignore  = 1;
            "minstreth"     : `CV32E40P_CORE.cs_registers_i.minstret_raw[63:32];
