...
import cv32e40p_pkg::*;// definitions of enumerated types used by cv32e40p
import uvmt_cv32e40p_pkg::*;

/**
 * Wrapper for the CV32E40P RTL DUT.
...
module uvmt_cv32e40p_dut_wrap #(
    ...
    assign interrupt_if.irq_id                  = cv32e40p_top_i.u_cv32e40p_top.u_cv32e40p_core.id_stage_i.controller_i.exc_cause_o[4:0]; //irq_id;
//    assign interrupt_if.irq_ack                 = cv32e40p_top_i.u_cv32e40p_top.u_cv32e40p_core.id_stage_i.controller_i.handle_irq; //irq_ack;
    assign interrupt_if.irq_ack                 = (cv32e40p_top_i.u_cv32e40p_top.u_cv32e40p_core.id_stage_i.controller_i.ctrl_fsm_cs == 4'h7);//irq_ack
    ...
    assign vp_interrupt_if.irq_id               = cv32e40p_top_i.u_cv32e40p_top.u_cv32e40p_core.id_stage_i.controller_i.exc_cause_o[4:0];    //irq_id;
    assign vp_interrupt_if.irq_ack              = (cv32e40p_top_i.u_cv32e40p_top.u_cv32e40p_core.id_stage_i.controller_i.ctrl_fsm_cs == 4'h7);//irq_ack
...
`define DUT_PATH        cv32e40p_top_i
`define CSR_PATH        `DUT_PATH.u_cv32e40p_top.u_cv32e40p_core.cs_registers_i
