...
function void uvma_cv32e40p_core_cntrl_agent_c::retrieve_vif();
   ...
   uvma_cv32e40p_core_cntrl_cntxt_c e20_cntxt;

   $cast(e20_cntxt, cntxt);

   // Core control interface
   if (!uvm_config_db#(virtual uvme_cv32e40p_core_cntrl_if)::get(this, "", $sformatf("core_cntrl_vif"), e20_cntxt.core_cntrl_vif)) begin
...
task uvma_cv32e40p_core_cntrl_agent_c::start_fetch_seq();

  uvme_cv32e40p_fetch_seq_c fetch_seq = uvme_cv32e40p_fetch_seq_c::type_id::create("fetch_seq");
