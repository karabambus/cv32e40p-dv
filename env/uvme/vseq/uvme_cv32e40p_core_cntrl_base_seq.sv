...
task uvme_cv32e40p_core_cntrl_base_seq_c::pre_start();
  ...
  if (!$cast(cfg, p_sequencer.cfg)) begin
    `uvm_fatal("E40SCORECNTRLSEQ", $sformatf("Could not cast p_sequencer.cfg to uvme_cv32e40p_cfg"))
  end

  if (!$cast(cntxt, p_sequencer.cntxt)) begin
    `uvm_fatal("E40SCORECNTRLSEQ", $sformatf("Could not cast p_sequencer.cntxt' to uvme_cv32e40p_cntxt'"))
  end
