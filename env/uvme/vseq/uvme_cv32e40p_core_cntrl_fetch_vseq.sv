...
`ifndef __UVME_CV32E40P_fetch_SEQ_C__
`define __UVME_CV32E40P_fetch_SEQ_C__

/**
 * Virtual sequence responsible for controlling fetch_en during tests
 */
class uvme_cv32e40p_fetch_seq_c extends uvme_cv32e40p_core_cntrl_base_seq_c;

  rand fetch_toggle_t fetch_mode;

  `uvm_object_utils_begin(uvme_cv32e40p_fetch_seq_c);
...
endclass : uvme_cv32e40p_fetch_seq_c

function uvme_cv32e40p_fetch_seq_c::new(string name = "");
...
task uvme_cv32e40p_fetch_seq_c::body();
...
task uvme_cv32e40p_fetch_seq_c::fetch_constant();
...
task uvme_cv32e40p_fetch_seq_c::fetch_initial_delay();
...
task uvme_cv32e40p_fetch_seq_c::fetch_random_toggle();
...
`endif // __UVME_CV32E40P_fetch_SEQ_C__
