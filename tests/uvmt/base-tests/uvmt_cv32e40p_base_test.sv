...
class uvmt_cv32e40p_base_test_c extends uvm_test;
   ...
   virtual uvme_cv32e40p_core_cntrl_if   core_cntrl_vif; // control inputs to the core
...
function void uvmt_cv32e40p_base_test_c::retrieve_vifs();
   ...
   if (!uvm_config_db#(virtual uvme_cv32e40p_core_cntrl_if)::get(this, "", "core_cntrl_vif", core_cntrl_vif)) begin
