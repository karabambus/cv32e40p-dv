...
`ifndef __UVMT_CV32E40P_GENERAL_PURPOSE_TEST_SV__
`define __UVMT_CV32E40P_GENERAL_PURPOSE_TEST_SV__


/**
 *  CV32E40P "general purpose firmware" test.
 ...
 */
class uvmt_cv32e40p_general_purpose_test_c extends uvmt_cv32e40p_base_test_c;

   constraint test_type_cons {
     test_cfg.tpt == GENERAL_PURPOSE;
   }

   `uvm_component_utils_begin(uvmt_cv32e40p_general_purpose_test_c)
   `uvm_object_utils_end

   /**
    */
   extern function new(string name="uvmt_cv32e40p_general_purpose_test", uvm_component parent=null);
...
endclass : uvmt_cv32e40p_general_purpose_test_c


function uvmt_cv32e40p_general_purpose_test_c::new(string name="uvmt_cv32e40p_general_purpose_test", uvm_component parent=null);
...
task uvmt_cv32e40p_general_purpose_test_c::run_phase(uvm_phase phase);
...
task uvmt_cv32e40p_general_purpose_test_c::reset_debug();
...
function void uvmt_cv32e40p_general_purpose_test_c::build_phase(uvm_phase phase);
...
task uvmt_cv32e40p_general_purpose_test_c::bootset_debug();
...
task uvmt_cv32e40p_general_purpose_test_c::random_debug();
...
task uvmt_cv32e40p_general_purpose_test_c::irq_noise();
...
task uvmt_cv32e40p_general_purpose_test_c::random_fetch_toggle();
...
`endif // __UVMT_CV32E40P_GENERAL_PURPOSE_TEST_SV__
